...
async function getProgrruledetails(programruleId) {  
  var url = `${process.env.REACT_APP_DHIS2_BASE_URL}/api/29/programRules/${programruleId}.json?paging=false&fields=*,`;
  let response = await fetch(url, {
    method: "GET",
    credentials: "include",
    headers: {
...
async function getprogramIndicatorGroup() {
  var url = `${process.env.REACT_APP_DHIS2_BASE_URL}/api/programIndicatorGroups.json?fields=id,name&paging=false`;
  let response = await fetch(url, {
    method: "GET",
    credentials: "include",
    headers: {
...
async function getProgramStages() {  
  var url = `${process.env.REACT_APP_DHIS2_BASE_URL}/api/29/programStages.json?fields=id,name&paging=false,`;
  let response = await fetch(url, {
    method: "GET",
    credentials: "include",
    headers: {
...
async function getDataElements() {  
  var url = `${process.env.REACT_APP_DHIS2_BASE_URL}/api/29/dataElements.json?fields=id,name&paging=false,`;
  let response = await fetch(url, {
    method: "GET",
    credentials: "include",
    headers: {
...
async function getTrackedEntityAttributes() {  
  var url = `${process.env.REACT_APP_DHIS2_BASE_URL}/api/29/trackedEntityAttributes.json?fields=id,name&paging=false,`;
  let response = await fetch(url, {
    method: "GET",
    credentials: "include",
    headers: {
