...
async function getRateSummary(datasetId,selectedOuID,ouChildrenIds,formattedPeriod) {
  var url = `${process.env.REACT_APP_DHIS2_BASE_URL}/api/analytics.json?dimension=dx:${datasetId}.ACTUAL_REPORTS;${datasetId}.EXPECTED_REPORTS;${datasetId}.REPORTING_RATE;${datasetId}.ACTUAL_REPORTS_ON_TIME;${datasetId}.REPORTING_RATE_ON_TIME&dimension=ou:${selectedOuID};${ouChildrenIds}&columns=dx&rows=ou&tableLayout=true&hideEmptyRows=true&displayProperty=SHORTNAME&includeNumDen=false&filter=pe:${formattedPeriod}`;
