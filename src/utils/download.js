...
export const tableToExcel = (function () {
    ...
    return function (container, name, filename, head) {
        if (!container.nodeType) { head ? container = document.getElementById(container).srcdoc : container = document.getElementById(container).innerHTML; }
